    ...
    <header class="navbar">
        ...
        <div class="profile-dropdown">
            <div class="profile-trigger">
                <img src="<?= app_config()['base_url'] ?>/public/assets/image/userlogo.png" alt="Admin">
                <div class="user-name">
        ...
        <div class="booking-card">
            ...
            <form action="<?= $isEdit ? '?route=Booking/adminEditStep2' : '?route=Booking/adminStep2' ?>" method="POST">
                ...
                <div class="btn-action-row">
                    <a href="?route=<?= $isEdit ? 'Admin/dataFromAdminCreateBooking' : 'admin/dataRuangan' ?>" class="btn btn-back">
                        Kembali
                    </a>

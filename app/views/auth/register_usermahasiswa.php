...
<div class="auth-wrapper">
    ...
    <section class="auth-card form-panel">
        <div class="form-header">
            ...
            <p>Isi data sesuai identitas dan bukti aktivasi Kubaca.</p>
        </div>
        ...
        <form class="login-form" method="POST" enctype="multipart/form-data" action="?route=Auth/registerMahasiswa">
            ...
            <label for="bukti_aktivasi">Bukti sudah aktivasi akun Kubaca</label>
...
if (fileInput) {
    fileInput.addEventListener('change', () => {
        fileText.textContent = fileInput.files.length ? fileInput.files[0].name : 'Belum ada file';
    });
}
</script>
